...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??_Gexception@std@@UEAAPEAXI@Z DD imagerel $LN6
	DD	imagerel $LN6+52
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??_Gbad_alloc@std@@UEAAPEAXI@Z DD imagerel $LN6
	DD	imagerel $LN6+52
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$??_Gbad_array_new_length@std@@UEAAPEAXI@Z DD imagerel $LN6
	DD	imagerel $LN6+52
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?_Adjust_manually_vector_aligned@std@@YAXAEAPEAXAEA_K@Z DD imagerel $LN23
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?_Orphan_all_unlocked_v3@_Container_base12@std@@AEAAXXZ DD imagerel $LN14
	DD	imagerel $LN14+70
...
; 15   :     _int64 ctr_1 = 0, ctr_2 = 0, freq = 0;
	...
	and	QWORD PTR ctr_1$[rbp-256], 0
	and	QWORD PTR ctr_2$[rbp-256], 0
	and	QWORD PTR freq$[rbp-256], 0
	xorps	xmm7, xmm7
	xor	ebx, ebx
	xor	edi, edi
...
; 22   :         B[n] = n / 3.0;
	...
	call	??A?$vector@MV?$allocator@M@std@@@std@@QEAAAEAM_K@Z ; std::vector<float,std::allocator<float> >::operator[]
	divsd	xmm6, QWORD PTR __real@4008000000000000
	cvtpd2ps xmm0, xmm6
	movss	DWORD PTR [rax], xmm0
...
; 27   :     vector<size_t> sizes = { 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536 };
	...
	movdqu	XMMWORD PTR $T3[rbp-256], xmm0
	lea	rcx, QWORD PTR $T1[rsp]
...
; 30   :     for (size_t size : sizes) {
	...
	cmp	rsi, rax
	je	$LN6@main
	lea	r13, OFFSET FLAT:??$endl@DU?$char_traits@D@std@@@std@@YAAEAV?$basic_ostream@DU?$char_traits@D@std@@@0@AEAV10@@Z ; std::endl<char,std::char_traits<char> >
$LL7@main:
...
; 50   :                 cout << "Run number: " << i + 1 << endl << "Running time: " << (ctr_2 - ctr_1) * 1.0 / freq << " seconds" << endl;
	...
	cvtsi2sd xmm6, rax
	xorps	xmm0, xmm0
	cvtsi2sd xmm0, QWORD PTR freq$[rbp-256]
	divsd	xmm6, xmm0
...
; 61   :         cout << "Average time: " << (total_time / 10) << endl;
	...
	movaps	xmm6, xmm7
	divsd	xmm6, QWORD PTR __real@4024000000000000
